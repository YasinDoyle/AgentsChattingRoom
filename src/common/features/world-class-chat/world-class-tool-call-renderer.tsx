...
export const WorldClassToolCallRenderer: React.FC<
  WorldClassToolCallRendererProps
> = ({ toolInvocation, onToolResult }) => {
  ...
  const isArgsEmpty =
    argsStr === "{}" || argsStr === undefined || argsStr === "null";
  ...
  const header = (
    ...
    >
      <span style={{ display: "flex", alignItems: "center", marginRight: 8 }}>
        ...
        >
          <path
            d="M13.5 8.5A5 5 0 0 1 7.5 2.5c0-.28.02-.56.07-.83a.5.5 0 0 0-.85-.45l-2.1 2.1a2.5 2.5 0 0 0 0 3.54l.7.7-3.09 3.09a1.5 1.5 0 0 0 2.12 2.12l3.09-3.09.7.7a2.5 2.5 0 0 0 3.54 0l2.1-2.1a.5.5 0 0 0-.45-.85c-.27.05-.55.07-.83.07Z"
            stroke="#22223b"
            strokeWidth="1.3"
            strokeLinecap="round"
    ...
    >
      ...
      >
        {renderer && typeof renderer.render === "function" ? (
          <div style={{ width: "100%" }}>
            {(() => {
              const maybeResult = (toolInvocation as { result?: unknown })
                .result;
              ...
              return renderer.render(toolCall, onToolResult || (() => {}));
            })()}
          </div>
        ) : (
          <pre
