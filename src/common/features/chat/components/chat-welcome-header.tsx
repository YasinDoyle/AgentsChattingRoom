...
export function ChatWelcomeHeader({
  ...
  const themeConfig = {
    magic: {
      centerContainer:
        "bg-gradient-to-br from-violet-600 via-purple-600 via-fuchsia-600 to-pink-600",
    ...
    tech: {
      centerContainer:
        "bg-gradient-to-br from-emerald-500 via-teal-500 via-blue-500 to-indigo-500",
      ...
      <div className={cn("relative mx-auto mb-6", sizeClasses[containerSize])}>
        ...
        {showMagicCircles && (
          <>
            ...
            <div
              className={cn(
                "absolute inset-0 rounded-full animate-spin opacity-25",
                config.circles.outer,
              )}
            ...
            <div
              className={cn(
                "absolute inset-2 border-2 border-dashed rounded-full animate-spin",
                config.circles.middle,
              )}
            ...
            <div
              className={cn(
                "absolute inset-1 rounded-full animate-ping opacity-15",
                config.circles.inner,
              )}
        ...
        >
          ...
          >
            <div
              className={cn("text-white drop-shadow-lg", centerIconClassName)}
            >
              {centerIcon}
            </div>
          </div>
