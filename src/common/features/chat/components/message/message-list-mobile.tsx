...
export const MessageListMobile = forwardRef<
  MessageListRef,
  MessageListMobileProps
>(function MessageListMobile({ className, scrollButtonThreshold = 200 }, ref) {
  ...
  return (
    <div className="h-full bg-gray-50 dark:bg-gray-900" data-capture-root>
      <ScrollableLayout
      ...
      >
        ...
        {/* 浮动按钮组 */}
        <div
          className="fixed right-3 bottom-24 flex flex-col gap-2 z-10"
          data-ignore-capture
        >
          {/* 消息捕获按钮 */}
          <MessageCapture
