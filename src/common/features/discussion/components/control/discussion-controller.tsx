...
import {
  UI_PERSIST_KEYS,
  createUIPersistOptions,
} from "@/core/config/ui-persist";
...
export function DiscussionController({
  ...
  const { settings, setSettings, messageCount, handleStatusChange } =
      ...
      <div className="px-4 py-2.5">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            />
            <StatusIndicator isActive={isActive} messageCount={messageCount} />
          </div>
