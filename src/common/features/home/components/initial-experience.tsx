                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground truncate">
                        {customMembers.length > 0
                          ? t("home.selectedExpertsCount", {
                              count: customMembers.length,
                            })
                    ...
                    <div className="space-y-1 max-h-[360px] overflow-y-auto p-2 scrollbar-thin pb-6">
                      {Object.entries(AGENT_COMBINATIONS).map(
                        ([key, combination]) => {
                          ...
                          const resolved = resolveCombination(
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-muted-foreground truncate">
                                  {combination.participants.length}{" "}
                                  {t("home.experts")}
                                </p>
                              </div>
                            </button>
