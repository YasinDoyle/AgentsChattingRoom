    ...
    suggestions: [
      {
        ...
        template:
          '我想创作一个故事，主题是"人工智能与人性"。请编剧从故事结构角度给出建议，作家探讨人物塑造，评论家分析类似主题的经典作品。',
      },
      {
        ...
        template:
          "让我们一起探讨一个面向老年人的智能家居产品创意。请产品经理思考用户需求，设计师关注交互体验，工程师评估技术可行性，社会学家分析老年群体特点。",
      },
    ],
  },
  {
    ...
    suggestions: [
      {
        ...
        template:
          '请让康德、尼采和庄子一起探讨"人工智能时代的自由意志"这个话题。每位哲学家都应该基于自己的哲学体系来分析。',
      },
      {
        id: "literary-salon",
        title: "文人雅集",
        ...
        template:
          '请苏轼、李白、王维就"明月几时有"展开探讨。每位诗人都用自己的诗词风格和意境来回应，品评明月之美。',
      },
    ],
  },
  {
    ...
    suggestions: [
      {
        ...
        template:
          '让我们探讨"2050年的教育将是什么样"。请未来学家预测技术发展，教育学家分析教育模式变革，心理学家思考学习方式演变，社会学家评估社会影响。',
      },
      {
        id: "case-analysis",
        title: "案例多维解析",
        ...
        template:
          "请分析特斯拉的商业模式创新。请商业分析师评估商业模式，技术专家分析技术优势，营销专家解读品牌策略，未来学家预测发展方向。",
      },
    ],
  },
  {
    ...
    suggestions: [
      {
        ...
        template:
          '让我们用不同的思维方式探讨"如何提升创造力"这个话题。请系统思考者分析整体框架，逆向思维者提出反常观点，横向思维者联系跨领域启发，辩证思维者探讨矛盾统一。',
      },
      {
        id: "problem-solving",
        title: "问题解决工作坊",
        ...
        template:
          '我们来探讨"如何减少城市交通拥堵"这个问题。请系统分析师建立问题框架，创新思维者提出突破性方案，批判性思维者评估可行性，整合性思维者寻找最优解。',
      },
    ],
  },
  {
    ...
    suggestions: [
      {
        ...
        template:
          '让我们一起创作一个短剧本。编剧负责故事框架，作家完善对话，导演把控节奏，音乐家设计配乐意境。主题是"在平行宇宙中相遇的自己"。',
      },
      {
        id: "art-critique",
        title: "艺术品鉴赏",
        ...
        template:
          "让我们一起赏析这幅画作：[描述或插入图片]。请艺术史学家分析其历史地位，美学家评价其艺术价值，画家分析其技法特点，哲学家探讨其深层寓意。",
      },
    ],
  },
];
