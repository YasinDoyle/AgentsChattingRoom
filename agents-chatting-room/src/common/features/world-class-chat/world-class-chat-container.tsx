...
import {
  ...
  type SuggestionsManager,
} from "./hooks/use-suggestions-manager";
    ...
    () => [
      ...
      },
      {
        ...
        render: (panelProps: unknown, close: () => void) => {
          const props = (panelProps ?? {}) as Partial<
            Parameters<typeof WorldClassChatHtmlPreview>[0]
          >;
          return (
            <WorldClassChatHtmlPreview
              {...(props as Parameters<typeof WorldClassChatHtmlPreview>[0])}
              onClose={close}
            />
          );
        },
